...
target="_blank" rel="noreferrer">
          ...
          <a href={`https://github.com/${userData.login}?tab=repositories`} target="_blank" rel="noreferrer">
            	<p>Repositórios públicos: {userData.public_repos}</p>
          </a>
          <a href={`https://github.com/${userData.login}?tab=followers`} target="_blank" rel="noreferrer"> 
            	<p>Seguidores: {userData.followers}</p>
          </a >
          <a href={`https://github.com/${userData.login}?tab=following`} target="_blank" rel="noreferrer">
